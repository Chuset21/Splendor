...
public class ReserveNobleCardTest {
    ...
    static final int gemDiscount = 3;
    ...
    public void setUp() {
        ...
        reserveNobleCard = new ReserveNobleCard(prestigePoints, cost, cardLevel, expansion, gemDiscount, discountColor);
    }
    ...
    public void testGemDiscount() {
        assertEquals(gemDiscount, reserveNobleCard.gemDiscount());
    }
    ...
    public void testEqualsByValue() {
        ReserveNobleCard cardWithEqualValues = new ReserveNobleCard(prestigePoints, cost, cardLevel, expansion, gemDiscount, discountColor);
