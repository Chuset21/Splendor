...
public final class LoginScreen extends Application {
  ...
  public void start(Stage stage) {
    ...
    final AnchorPane root =
        new AnchorPane(splendorText, quitButton, username, password, centeredWCM, loginButton);
    final Scene scene = new Scene(root, WIDTH, HEIGHT);
    scene.getStylesheets()
        .add(Objects.requireNonNull(getClass().getResource("login.css")).toExternalForm());
